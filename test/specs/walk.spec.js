...
import { parse, walk } from '../../dist/node/index.js';
...
.clearfix:before {
  ...
  width: 0;
        ...
        const values = ['StyleSheet', 'Rule', 'Declaration', 'Declaration'];
...
`;
        ...
        const values = ['StyleSheet', 'AtRule', 'Rule', 'Declaration', 'Declaration', 'Declaration', 'Declaration'];
