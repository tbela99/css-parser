...
export function run(describe, expect, transform, parse, render) {
    ...
    describe('convert to oklab', function () {

        it('hex to oklab #1', function () {
        ...
        it('device-cmyk() to oklab #3', function () {
        ...
        it('srgb-linear to oklab #6', function () {
            return transform(`.hsl { color: color(srgb-linear .45078578283822346 .01599629336550963 .01599629336550963/50%); }`, {
                beautify: true,
                convertColor: ColorType.OKLAB
            }).then(result => expect(isOkLabClose(result.ast.chi[0].chi[0].val[0], {
        ...
        it('display-p3 to oklab #7', function () {
        ...
        it('a98-rgb to oklab #8', function () {
        ...
        it('photo-rgb to oklab #9', function () {
        ...
        it('rec2020 to oklab #10', function () {
        ...
        it('xyz-d50 to oklab #12', function () {
        ...
        it('xyz-d65 to oklab #13', function () {
            return transform(`.hsl { color: color(xyz .1945069569161969 .108449498170369 .025825724073578846/50%); }`, {
                beautify: true,
                convertColor: ColorType.OKLAB
            }).then(result => expect(isOkLabClose(result.ast.chi[0].chi[0].val[0], {
