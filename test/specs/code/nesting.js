...
`;
            return transform(file, {
                nestingRules: true,
                minify: true
            }).then(result => expect(result.code).equals(`a{color:rgba(var(--bs-link-color-rgb),var(--bs-link-opacity,1));text-decoration:underline;:hover,& span{--bs-link-color-rgb:var(--bs-link-hover-color-rgb)}}`));
        });
