...
export function run(describe, expect, it, transform, parse, render) {
    ...
    describe('convert to srgb', function () {

        it('rgb(a) to srgb #1', function () {
            return transform(`.hsl { color: rgb(179 34 34/50%); }`, {
                ...
                convertColor:  ColorType.SRGB
                    ...
                    "val": "color",
                    "chi": [{"typ": 7, "val": "display-p3"}, {"typ": 12, "val": "0.6449802764484531"}, {
                        "typ": 12,
                        "val": "0.19119980094061145"
                    }, {"typ": 12, "val": "0.16577088540310694"}, {"typ": 6, "val": "/"}, {"typ": 14, "val": "50"}],
                    "kin":  ColorType.COLOR
                }
            )).equals(true));
        });

        it('hsl(a) to srgb #2', function () {
        ...
        it('device-cmyk() to srgb #3', function () {
        ...
        it('srgb-linear to srgb #6', function () {
        ...
        it('display-p3 to srgb #7', function () {
        ...
        it('photo-rgb to srgb #9', function () {
        ...
        it('rec2020 to srgb #10', function () {
            return transform(`.hsl { color: color(prophoto-rgb 0.4589 0.2071 0.124 / 0.50); }`, {
                beautify: true,
                convertColor:  ColorType.SRGB
            }).then(result => expect(isOkLabClose(result.ast.chi[0].chi[0].val[0], {
        ...
        it('xyz-d50 to srgb #12', function () {
        ...
        it('xyz-d65 to srgb #13', function () {
            return transform(`.hsl { color: color(xyz-d65 0.1945 0.1084 0.0258 / 0.50); }`, {
                beautify: true,
                convertColor:  ColorType.SRGB
            }).then(result => expect(isOkLabClose(result.ast.chi[0].chi[0].val[0], {
