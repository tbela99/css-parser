...
//             return readFile((import.meta.dirname ?? dirname(new URL(import.meta.url).pathname)) + '/../../files/result/font-awesome-all.css', 'utf-8').
//             then(file => transform(import1, {
//                 minify: false,
//                 resolveImport: true
//             }).
//             then((result) => expect(result.code).equals(file)));
//         });
//     });
