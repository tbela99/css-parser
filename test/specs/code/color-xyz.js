...
export function run(describe, expect, it, transform, parse, render) {
    ...
    describe('convert to xyz', function () {

        it('rgb(a) to xyz #1', function () {
                ...
                convertColor: ColorType.SRGB_LINEAR
                    ...
                    chi: [
                        ...
                        },
                        {
                            ...
                            val: ".1945069569161969"
                        }, {
                            typ: EnumToken.NumberTokenType,
                            val: ".108449498170369"
                        }, {
                            typ: EnumToken.NumberTokenType,
                            val: ".025825724073578846"
                        },
                        {
        ...
        it('device-cmyk() to xyz #3', function () {
        ...
        it('srgb-linear to xyz #6', function () {
        ...
        it('display-p3 to xyz #7', function () {
        ...
        it('photo-rgb to xyz #9', function () {
