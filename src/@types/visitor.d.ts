 ...
 */
export declare type RuleVisitorHandler  = (node: AstRule) => AstRule | AstRule[] | void | null;;
/**
 * AtRule visitor handler
 */
export declare type AtRuleVisitorHandler  = (node: AstAtRule) => AstAtRule | AstAtRule[] | void | null;;
/**
 * Value visitor handler
 */
export declare type ValueVisitorHandler  = (node: Token) => Token | Token[] | void | null;;

export interface VisitorNodeMap {
