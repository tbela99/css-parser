import {
    ...
    ParserOptions, Position, PseudoClassFunctionToken, PseudoClassToken, StringToken, Token, TransformOptions, UrlToken
} from "../@types";
import {
    isAtKeyword,
    isDimension,
...
export function parse(iterator: string, opt: ParserOptions = {}): ParseResult {
