...
export function length2Px(value: LengthToken | NumberToken): number | null {
    ...
    switch ((value as LengthToken).unit) {
        case 'cm':
            // @ts-ignore
            return (value as LengthToken).val * 37.8;
        case 'mm':
            // @ts-ignore
            return (value as LengthToken).val * 3.78;
        case 'Q':
            // @ts-ignore
            return (value as LengthToken).val * 37.8 / 40;
        case 'in':
            // @ts-ignore
            return (value as LengthToken).val / 96;
        case 'pc':
            // @ts-ignore
            return (value as LengthToken).val / 16;
        case 'pt':
            // @ts-ignore
            return (value as LengthToken).val * 4 / 3;
        case 'px':
            return +(value as LengthToken).val;
    }
