...
export const pageMarginBoxType: Set<string> = new Set([
    "top-left-corner",
    "top-left",
    "top-center",
    "top-right",
...
export const timingFunc: string[] = [
    "ease",
    "ease-in",
    "ease-out",
    "ease-in-out",
...
export const colorsFunc: string[] = [
    "rgb",
    "rgba",
    "hsl",
    "hsla",
...
export const colorFuncColorSpace: string[] = [
    "srgb",
    "srgb-linear",
    "display-p3",
    "prophoto-rgb",
...
export const D50: number[] = [0.3457 / 0.3585, 1.0, (1.0 - 0.3457 - 0.3585) / 0.3585];

export const k: number = Math.pow(29, 3) / Math.pow(3, 3);
export const e: number = Math.pow(6, 3) / Math.pow(29, 3);

export const nonStandardColors: Set<string> = new Set(
    config.syntaxes["-non-standard-color"].syntax.split(/[\s|]+/g).map((m: string) => m.toLowerCase()),
);

// color module v4
export const systemColors: Set<string> = new Set(
    [
        "ActiveText",
        "ButtonBorder",
        "ButtonFace",
...
// deprecated
export const deprecatedSystemColors: Set<string> = new Set(
    [
        "ActiveBorder",
        "ActiveCaption",
        "AppWorkspace",
...
export const NAMES_COLORS: { [key: string]: string } = Object.seal(
    Object.entries(COLORS_NAMES).reduce(
        (
            acc: {
                [key: string]: string;
            },
...
export const trimTokenSpace: Set<EnumToken> = new Set([
    EnumToken.Add,
    EnumToken.Mul,
    EnumToken.Div,
    EnumToken.Sub,
