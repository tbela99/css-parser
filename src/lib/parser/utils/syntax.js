...
export function isLength(dimension) {
...
export function isIdentStart(codepoint) {
    // _
...
export function isIdentCodepoint(codepoint) {
    // -
...
export function isPercentage(name) {
...
export function isHexColor(name) {
...
export function isHexDigit(name) {
...
function isEscape(name) {
    return name.charCodeAt(0) == REVERSE_SOLIDUS && !isNewLine(name.charCodeAt(1));
}
export function isFunction(name) {
    return name.endsWith('(') && isIdent(name.slice(0, -1));
}
export function isAtKeyword(name) {
