 ...
 * @param position
 */
export declare function reducegradientBackgroundPosition(positions: Token[], position: string): void;
export declare function reduceConicColorStops(stops: Token[]): Token[];
