 ...
 */
const funcTypes = Array.from(tokensfuncDefMap.values());
...
export { createValidationContext, funcTypes, getMFInfo, isMFValue, matchAllSyntaxes, matchOccurenceSyntax, matchSelectorSyntax, trimArray };
