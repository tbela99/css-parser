...
declare enum EnumToken {
     ...
     * infinity token
     */
    InfinityTokenType = 142,
    /**
     * negative infinity token
     */
    NegativeInfinityTokenType = 143,
    /**
 ...
 * ```
 */
declare function walk(node: AstNode$1, filter?: WalkerOptions | null): Generator<WalkResult>;
/**
...
declare class SourceFile {
     ...
     */
    setInputSourceMap(inputSourceMap: SourceMapObject | string | null): void;
    /**
...
interface ValidationSyntaxResult extends ValidationResult {
     ...
     * context
     */
    context: ValidationContext<Token$1> | Token$1[];
}
...
declare class PropertyList {
    ...
    add(declarations: AstNode$1[]): this;
    mapValues(declaration: AstDeclaration, mapping: SinglePropertyTypeMapping): void;
    [Symbol.iterator](): {
        next(): {
            value: AstNode$1;
            done: boolean;
